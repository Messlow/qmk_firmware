...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_COLEMAK_LAYER] = LAYOUT(
        ...
        KC_LSFT,  KC_Z,         KC_X,         KC_C,         KC_D,         KC_V, KC_MPLY,        MS_BTN3, KC_K,     KC_H,     KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                        KC_LCTL, KC_LALT, LT(NAVIGATION_LAYER, KC_ESC), KC_ENT, KC_DEL,    KC_BSPC, LT(SYMBOL_LAYER, KC_SPC),  LT(FUNCTION_LAYER, KC_ESC),  KC_RALT, KC_RCTL
    ),
    ...
    [SYMBOL_LAYER] = LAYOUT(
        ...
        _______, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, _______,       _______, _______, _______, _______, _______, _______, _______,
                             _______, _______, _______, _______, _______,  _______, _______, _______,  _______, _______
    ),
