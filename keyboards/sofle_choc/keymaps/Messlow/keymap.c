...
// TODO: missing keys ç ¨ `
// TODO: fill thumb clusters (probably shortcuts or OSM keys or toggles for additional shortcut layers)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE_COLEMAK_LAYER] = LAYOUT(
        ...
        // Right top row
        KC_J, KC_L, KC_U, KC_Y, FR_SCLN, FR_DCIR,

        // Left home row
        KC_NO, LGUI_T(KC_A), LALT_T(KC_R), LSFT_T(KC_S), LCTL_T(KC_T), KC_G,
        // Right home row
        KC_M, RCTL_T(KC_N), RSFT_T(KC_E), RALT_T(KC_I), RGUI_T(KC_O), FR_SCLN,

        // Left bottom row + encoder
        KC_NO, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_MPLY,
        // Right bottom row + encoder
        MS_BTN3, KC_K, KC_H, KC_COMM, KC_DOT, FR_EACU, FR_DGRV,

        // Left thumb cluster
        KC_NO, KC_NO, KC_ESC, LT(NAVIGATION_LAYER, KC_SPC), KC_TAB,
        // Right thumb cluster
        KC_ENT, LT(SYMBOL_LAYER, KC_BSPC), KC_DEL, KC_NO, KC_NO),
